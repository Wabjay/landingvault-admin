...
const InfoCard = ({ info, pageName }) => {
  ...
  return (
    <div className="relative flex flex-col gap-3 p-6 bg-white border border-[#21AB68] text-[#2D2D2D] shadow-metric-card">
      <SkeletonLoader>
      ...
      <div className="flex flex-col gap-6 tablet:flex-row justify-between">
        <Link href={{
          ...
          query: { ref: pageName }, // Example query parameters
        }}
